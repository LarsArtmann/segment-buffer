...
- `[ ]` **Extract `NopCipher` test helper.** The `NopCipher` struct + its
  ...
  Source: [`docs/status/archived/2026-08-10_06-01_code-quality-triple-partialEq-validate-seal.md`](docs/status/archived/2026-08-10_06-01_code-quality-triple-partialEq-validate-seal.md) § e.5.
...
- `[ ]` **`format_bytes_human` edge-case unit tests.** The private
  ...
  Source: [`docs/status/archived/2026-08-10_06-01_code-quality-triple-partialEq-validate-seal.md`](docs/status/archived/2026-08-10_06-01_code-quality-triple-partialEq-validate-seal.md) § e.6.
...
- `[ ]` **Default-value regression guard for `compression_level`.** Add a
  ...
  Source: [`docs/status/archived/2026-08-10_15-51_performance-benchmark-expansion-compression-sweep-default-change.md`](docs/status/archived/2026-08-10_15-51_performance-benchmark-expansion-compression-sweep-default-change.md) § f.42.
...
- `[ ]` **Run `bench_segment_size_stats` and `bench_cipher` at least once.**
  ...
  Source: [`docs/status/archived/2026-08-10_06-51_testing-and-benchmark-coverage-expansion.md`](docs/status/archived/2026-08-10_06-51_testing-and-benchmark-coverage-expansion.md) § e.1–e.2.
...
- `[ ]` **Update `docs/PERFORMANCE.md` baseline snapshot.** The baseline
  ...
  Source: [`docs/status/archived/2026-08-10_15-51_performance-benchmark-expansion-compression-sweep-default-change.md`](docs/status/archived/2026-08-10_15-51_performance-benchmark-expansion-compression-sweep-default-change.md) § b.2.
...
- `[ ]` **Write compression-sweep analysis doc.** The TSV data exists at
  ...
  sweep data.
  Source: [`docs/status/archived/2026-08-10_15-51_performance-benchmark-expansion-compression-sweep-default-change.md`](docs/status/archived/2026-08-10_15-51_performance-benchmark-expansion-compression-sweep-default-change.md) § b.3.
...
- `[ ]` **Document concurrent-append and real-disk findings in
  ...
  in PERFORMANCE.md.
  Source: [`docs/status/archived/2026-08-10_15-51_performance-benchmark-expansion-compression-sweep-default-change.md`](docs/status/archived/2026-08-10_15-51_performance-benchmark-expansion-compression-sweep-default-change.md) § a.8–a.9.
...
- `[ ]` **Add remaining 5 fuzz targets to CI fuzz workflow.**
  ...
  Source: [`docs/status/archived/2026-08-10_06-51_testing-and-benchmark-coverage-expansion.md`](docs/status/archived/2026-08-10_06-51_testing-and-benchmark-coverage-expansion.md) § e.2.
...
- `[ ]` **Fix "Update flake.lock" scheduled workflow.** The workflow at
  ...
  Source: [`docs/status/archived/2026-08-10_09-23_v0-5-6-release-self-critique-and-forward-plan.md`](docs/status/archived/2026-08-10_09-23_v0-5-6-release-self-critique-and-forward-plan.md) § c.20.
...
- `[ ]` **Add Cargo.lock version-sync check to `scripts/verify-gate.sh`.** A
  ...
  Source: [`docs/status/archived/2026-08-10_16-32_v0.5.7-release-and-self-critique.md`](docs/status/archived/2026-08-10_16-32_v0.5.7-release-and-self-critique.md) § d.1, e.1–e.3.
