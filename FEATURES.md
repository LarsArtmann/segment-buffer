...
| Capability                                 | Status           | Notes                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ------------------------------------------ | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Unit tests (81) + property tests (15)      | FULLY_FUNCTIONAL | CRUD, partial reads, limits, crash recovery, concurrency, error paths, envelope detection, encrypted-legacy read, append_all batch semantics, sync_disk_bytes, re-entrancy guard, IoSite, XChaCha20, flock contention. Counts verified by `grep -c '#\[test\]' src/tests.rs` (81) and `grep -c '#\[test\]' src/property_tests.rs` (15).                                                                                        |
